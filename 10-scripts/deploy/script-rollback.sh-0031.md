...
Este documento descreve Script: rollback.sh no contexto da AIRich Tecnologia.

Alinhado com as melhores práticas do mercado, Script: rollback.sh segue padrões estabelecidos pelas equipes da AIRich Tecnologia.
