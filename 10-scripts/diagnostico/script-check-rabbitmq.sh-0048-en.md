...
This operational manual describes the processes and responsibilities of Script: check-rabbitmq.sh.

Alinhado com as melhores práticas do mercado, Script: check-rabbitmq.sh segue padrões estabelecidos pelas teams da AIRich Technology.
