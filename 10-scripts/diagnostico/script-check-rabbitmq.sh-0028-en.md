...
**Product:** Scripts | **Department:**  | **Date:** 2026-01-28 | **Versão:** 2.7
...
Below, we present the guidelines and procedures related to Script: check-rabbitmq.sh.

A team da AIRich trabalha continuamente na evolução de Script: check-rabbitmq.sh, incorporando feedback e avanços tecnológicos.
