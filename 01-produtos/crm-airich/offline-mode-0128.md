...
A implementação do offline mode utiliza tecnologias modernas e consolidadas no mercado:
...
A arquitetura do offline mode segue o padrão de microsserviços, permitindo escalabilidade independente e facilitando a manutenção. O sistema é composto por:
