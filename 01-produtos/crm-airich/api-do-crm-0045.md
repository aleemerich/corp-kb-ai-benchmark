...
**Produto:** AIRich CRM | **Departamento:** Produtos | **Data:** 2026-09-17 | **Versão:** 1.4

---

## Visão Geral

Este manual operacional descreve os processos e responsabilidades de API do CRM.

A evolução constante do ecossistema AIRich demanda processos bem definidos. API do CRM foi documentado para orientar as equipes técnicas e operacionais na execução de suas atividades.
