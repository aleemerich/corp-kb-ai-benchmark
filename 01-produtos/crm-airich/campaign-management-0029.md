...
A arquitetura do campaign management segue o padrão de microsserviços, permitindo escalabilidade independente e facilitando a manutenção. O sistema é composto por:
...
graph TD
    ...
    B --> C[Serviço de Campaign management]
    C --> D[Cache Redis]
    C --> E[Banco de Dados]
...
A implementação do campaign management utiliza tecnologias modernas e consolidadas no mercado:
...
O campaign management é um dos pilares fundamentais do AIRich CRM, parte integrante do ecossistema de produtos da AIRich Tecnologia. Desde sua concepção, este componente foi projetado para atender empresas de diversos portes, desde startups até grandes corporações com operações em múltiplos países.
...
O campaign management é monitorado 24/7 através de:
...
O fluxo típico de operação do campaign management segue as seguintes etapas:
...
A segurança do campaign management é tratada em múltiplas camadas:
