...
**Product:** AIRich CRM | **Department:** Products | **Date:** 2026-07-13

---

## Visão Geral

This operational manual describes the processes and responsibilities of Estágios do pipeline.

A team de product da AIRich trabalha continuamente na evolução de Estágios do pipeline, incorporando feedback de clients e avanços tecnológicos para manter a competitividade da plataforma.
