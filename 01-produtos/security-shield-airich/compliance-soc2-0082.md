...
**Produto:** AIRich Security Shield | **Departamento:** Produtos | **Data:** 2026-01-26

---

## Visão Geral

Este manual operacional descreve os processos e responsabilidades de Compliance SOC2.

A evolução constante do ecossistema AIRich demanda processos bem definidos. Compliance SOC2 foi documentado para orientar as equipes técnicas e operacionais na execução de suas atividades.
