...
**Product:** AIRich Security Shield | **Department:** Products | **Date:** 2026-07-22

---

## Visão Geral

Below, we present the guidelines and procedures related to CSP headers.

A evolução constante do ecossystem AIRich demanda processs bem definidos. CSP headers foi documentado para orientar as teams técnicas e operacionais na execução de suas atividades.
