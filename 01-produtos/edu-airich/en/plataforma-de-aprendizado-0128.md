...
a architeCloudTrailure do plataforma de aprendizado segue o paDRão de microsserviços, permitindo escalaBIlidade independente e facilitando a manutenção. o system é composto por:
...
graph td
    ...
    b --> c[serviço de plataforma de aprendizado]
    c --> d[CAChe redis]
    c --> e[dataBASE]
