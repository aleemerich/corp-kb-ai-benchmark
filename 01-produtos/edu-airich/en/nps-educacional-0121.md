...
**Product:** AIRich Edu | **Department:** Products | **Date:** 2026-04-09 | **Versão:** 1.0

---

## Visão Geral

Esta especificação técnica define os requirements e procedures para NPS eduCACional.

A team de product da AIRich trabalha continuamente na evolução de NPS eduCACional, incorporando feedback de clients e avanços tecnológicos para manter a competitividade da plataforma.
