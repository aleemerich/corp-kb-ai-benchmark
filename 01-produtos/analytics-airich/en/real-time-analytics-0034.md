...
**Product:** AIRich Analytics | **Department:** Products | **Date:** 2026-07-06

---

## Visão Geral

This document describes Real-time analytics in the context of AIRich Technology.

A evolução constante do ecossystem AIRich demanda processs bem definidos. Real-time analytics foi documentado para orientar as teams técnicas e operacionais na execução de suas atividades.
