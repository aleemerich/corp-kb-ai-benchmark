...
**Produto:** AIRich Platform | **Departamento:** Produtos | **Data:** 2026-02-02 | **Versão:** 2.1
...
O objetivo deste material é documentar as práticas recomendadas para Arquitetura de microsserviços.

A evolução constante do ecossistema AIRich demanda processos bem definidos. Arquitetura de microsserviços foi documentado para orientar as equipes técnicas e operacionais na execução de suas atividades.
