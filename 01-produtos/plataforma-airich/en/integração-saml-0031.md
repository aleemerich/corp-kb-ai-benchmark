...
**Product:** AIRich Platform | **Department:** Products | **Date:** 2026-04-03

---

## Visão Geral

Este document fornece uma visão detalhada sobre Integração SAML in the AIRich ecosystem.

Como parte do programa de melhorAI contínua da AIRich, Integração SAML foi estruturado para atender às necessidades de escalabilidade, segurança e performance exigidas pelo mercado.
