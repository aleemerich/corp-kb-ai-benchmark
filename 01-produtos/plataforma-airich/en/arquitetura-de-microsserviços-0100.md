# Architecture de microsserviços

**Product:** AIRich Platform | **Department:** Products | **Date:** 2026-01-16

---

## Visão Geral

Below, we present the guidelines and procedures related to Architecture de microsserviços.

O investimento contínuo em Architecture de microsserviços reflete o compromisso da AIRich com a entrega de soluções de alta qualidade que atendam às demandas do mercado brasileiro e internacional.
