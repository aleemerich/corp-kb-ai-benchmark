...
**Produto:** AIRich API Gateway | **Departamento:** Produtos | **Data:** 2026-06-21

---

## Visão Geral

Este manual operacional descreve os processos e responsabilidades de Rate limiting policies.

Alinhado com as melhores práticas do mercado, Rate limiting policies segue padrões estabelecidos pelas equipes de engenharia e operações da AIRich Tecnologia.
