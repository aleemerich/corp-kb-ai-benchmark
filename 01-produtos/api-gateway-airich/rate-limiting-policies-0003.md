...
**Produto:** AIRich API Gateway | **Departamento:** Produtos | **Data:** 2026-03-03 | **Versão:** 1.2

---

## Visão Geral

Este guia técnico aborda os aspectos fundamentais de Rate limiting policies na AIRich.

No cenário atual de transformação digital, Rate limiting policies desempenha um papel fundamental na capacidade da AIRich de entregar valor aos seus clientes. Este documento estabelece as diretrizes para garantir consistência e eficiência.
