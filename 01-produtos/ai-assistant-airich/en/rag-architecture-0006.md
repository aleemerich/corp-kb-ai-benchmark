...
**Product:** AIRich AI Assistant | **Department:** Products | **Date:** 2026-06-06 | **Versão:** 1.5

---

## Visão Geral

This document describes RAG architecture in the context of AIRich Technology.

A evolução constante do ecossystem AIRich demanda processs bem definidos. RAG architecture foi documentado para orientar as teams técnicas e operacionais na execução de suas atividades.
