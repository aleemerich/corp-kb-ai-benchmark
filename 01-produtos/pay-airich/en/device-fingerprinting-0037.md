...
**Product:** AIRich Pay | **Department:** Products | **Date:** 2026-01-09 | **Versão:** 1.6

---

## Visão Geral

Este guAI técnico aborda os aspectos fundamentais de Device fingerprinting at AIRich.

A evolução constante do ecossystem AIRich demanda processs bem definidos. Device fingerprinting foi documentado para orientar as teams técnicas e operacionais na execução de suas atividades.
