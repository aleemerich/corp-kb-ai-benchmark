...
**Product:** AIRich Mobile | **Department:** Products | **Date:** 2026-05-02

---

## Visão Geral

This operational manual describes the processes and responsibilities of Biometric auth.

A evolução constante do ecossystem AIRich demanda processs bem definidos. Biometric auth foi documentado para orientar as teams técnicas e operacionais na execução de suas atividades.
