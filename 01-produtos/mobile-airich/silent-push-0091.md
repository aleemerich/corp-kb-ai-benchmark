...
O silent push é um dos pilares fundamentais do AIRich Mobile, parte integrante do ecossistema de produtos da AIRich Tecnologia. Desde sua concepção, este componente foi projetado para atender empresas de diversos portes, desde startups até grandes corporações com operações em múltiplos países.
...
A implementação do silent push utiliza tecnologias modernas e consolidadas no mercado:
...
O fluxo típico de operação do silent push segue as seguintes etapas:
...
A arquitetura do silent push segue o padrão de microsserviços, permitindo escalabilidade independente e facilitando a manutenção. O sistema é composto por:
...
O silent push é monitorado 24/7 através de:
