...
O objetivo deste material é documentar as práticas recomendadas para Sprint goal setting.

Como parte do programa de melhoria contínua da AIRich, Sprint goal setting foi estruturado para atender às necessidades de escalabilidade e segurança.
