...
Esta especificação técnica define os requisitos e procedimentos para Cloud: GCP backup.

A equipe da AIRich trabalha continuamente na evolução de Cloud: GCP backup, incorporando feedback e avanços tecnológicos.
