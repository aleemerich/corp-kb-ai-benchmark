# Cloud: AWS account staging

**Product:** Infrastructure | **Department:**  | **Date:** 2026-05-23 | **Versão:** 1.2

---

## Visão Geral

This document describes Cloud: AWS account staging in the context of AIRich Technology.

O investimento contínuo em Cloud: AWS account staging reflete o compromisso da AIRich com a entrega de soluções de alta qualidade.
