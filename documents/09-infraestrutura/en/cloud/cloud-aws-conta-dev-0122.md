...
**Product:** Infrastructure | **Department:**  | **Date:** 2026-05-10 | **Versão:** 1.1

---

## Visão Geral

This operational manual describes the processes and responsibilities of Cloud: AWS account dev.

No cenário atual de transformação digital, Cloud: AWS account dev plays a fundamental role in AIRich's ability to deliver value to its clients.
