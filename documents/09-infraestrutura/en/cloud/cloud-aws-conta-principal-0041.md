...
**Product:** Infrastructure | **Department:**  | **Date:** 2026-05-13

---

## Visão Geral

Este document fornece uma visão detalhada sobre Cloud: AWS account principal in the AIRich ecosystem.

Alinhado com as melhores práticas do mercado, Cloud: AWS account principal segue padrões estabelecidos pelas teams da AIRich Technology.
