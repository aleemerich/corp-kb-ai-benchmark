...
Esta especificação técnica define os requirements e procedures para Hardening: Linux.

A evolução constante do ecossystem AIRich demanda processs bem definidos. Hardening: Linux was documented to guide the teams.
