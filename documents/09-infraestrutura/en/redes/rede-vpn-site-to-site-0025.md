...
**Product:** Infrastructure | **Department:**  | **Date:** 2026-07-25 | **Versão:** 1.4

---

## Visão Geral

Este document fornece uma visão detalhada sobre Rede: VPN site-to-site in the AIRich ecosystem.

A evolução constante do ecossystem AIRich demanda processs bem definidos. Rede: VPN site-to-site was documented to guide the teams.
