...
Esta especificação técnica define os requisitos e procedimentos para Hardening: Linux.

A evolução constante do ecossistema AIRich demanda processos bem definidos. Hardening: Linux foi documentado para orientar as equipes.
