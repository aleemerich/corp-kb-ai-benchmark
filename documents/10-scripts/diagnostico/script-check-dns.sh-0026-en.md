...
**Product:** Scripts | **Department:**  | **Date:** 2026-08-26 | **Versão:** 1.5

---

## Visão Geral

This document describes Script: check-DNS.sh in the context of AIRich Technology.

Alinhado com as melhores práticas do mercado, Script: check-DNS.sh segue padrões estabelecidos pelas teams da AIRich Technology.
