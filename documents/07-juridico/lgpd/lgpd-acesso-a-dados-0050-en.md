...
Esta especificação técnica define os requirements e procedures para LGPD: Acesso a data.

A team da AIRich trabalha continuamente na evolução de LGPD: Acesso a data, incorporando feedback e avanços tecnológicos.
