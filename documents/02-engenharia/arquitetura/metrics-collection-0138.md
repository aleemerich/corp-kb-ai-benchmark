...
Esta especificação técnica define os requisitos e procedimentos para Metrics collection.

O investimento contínuo em Metrics collection reflete o compromisso da AIRich com a entrega de soluções de alta qualidade.
