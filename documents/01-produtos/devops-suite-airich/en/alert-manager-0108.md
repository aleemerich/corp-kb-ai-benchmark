...
**Product:** AIRich DevOps Suite | **Department:** Products | **Date:** 2026-09-24

---

## Visão Geral

This operational manual describes the processes and responsibilities of Alert manager.

A evolução constante do ecossystem AIRich demanda processs bem definidos. Alert manager foi documentado para orientar as teams técnicas e operacionais na execução de suas atividades.
