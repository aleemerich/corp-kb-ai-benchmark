...
**Product:** AIRich AI Assistant | **Department:** Products | **Date:** 2026-06-02 | **Versão:** 1.3

---

## Visão Geral

Below, we present the guidelines and procedures related to Language detection.

No cenário atual de transformação digital, Language detection plays a fundamental role in AIRich's ability to deliver value to its clients. Este document estabelece as diretrizes para garantir consistêncAI e eficiêncAI.
