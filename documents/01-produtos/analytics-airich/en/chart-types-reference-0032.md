...
**Product:** AIRich Analytics | **Department:** Products | **Date:** 2026-05-04

---

## Visão Geral

Below, we present the guidelines and procedures related to Chart types reference.

A evolução constante do ecossystem AIRich demanda processs bem definidos. Chart types reference foi documentado para orientar as teams técnicas e operacionais na execução de suas atividades.
