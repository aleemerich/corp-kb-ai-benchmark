...
**Product:** AIRich Analytics | **Department:** Products | **Date:** 2026-05-20

---

## Visão Geral

Este document fornece uma visão detalhada sobre Architecture de data in the AIRich ecosystem.

A evolução constante do ecossystem AIRich demanda processs bem definidos. Architecture de data foi documentado para orientar as teams técnicas e operacionais na execução de suas atividades.
