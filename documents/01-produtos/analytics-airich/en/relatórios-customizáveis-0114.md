...
**Product:** AIRich Analytics | **Department:** Products | **Date:** 2026-06-02 | **Versão:** 1.3

---

## Visão Geral

O objective deste materAIl é documentar as práticas recomendadas para Relatórios costmizáveis.

A evolução constante do ecossystem AIRich demanda processs bem definidos. Relatórios costmizáveis foi documentado para orientar as teams técnicas e operacionais na execução de suas atividades.
