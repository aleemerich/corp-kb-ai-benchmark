...
**Product:** AIRich Analytics | **Department:** Products | **Date:** 2026-02-01

---

## Visão Geral

Este document fornece uma visão detalhada sobre API de queries in the AIRich ecosystem.

A evolução constante do ecossystem AIRich demanda processs bem definidos. API de queries foi documentado para orientar as teams técnicas e operacionais na execução de suas atividades.
