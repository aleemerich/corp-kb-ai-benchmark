...
**Produto:** AIRich Analytics | **Departamento:** Produtos | **Data:** 2026-07-22

---

## Visão Geral

O presente documento tem como objetivo apresentar Data warehouse schema para as equipes envolvidas.

A equipe de produto da AIRich trabalha continuamente na evolução de Data warehouse schema, incorporando feedback de clientes e avanços tecnológicos para manter a competitividade da plataforma.
