...
**Produto:** AIRich Platform | **Departamento:** Produtos | **Data:** 2026-06-06 | **Versão:** 1.5

---

## Visão Geral

Este guia técnico aborda os aspectos fundamentais de Integração com API Gateway na AIRich.

Alinhado com as melhores práticas do mercado, Integração com API Gateway segue padrões estabelecidos pelas equipes de engenharia e operações da AIRich Tecnologia.
