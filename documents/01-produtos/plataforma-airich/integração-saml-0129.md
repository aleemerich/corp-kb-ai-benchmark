...
**Produto:** AIRich Platform | **Departamento:** Produtos | **Data:** 2026-03-17 | **Versão:** 1.8

---

## Visão Geral

Este manual operacional descreve os processos e responsabilidades de Integração SAML.

A equipe de produto da AIRich trabalha continuamente na evolução de Integração SAML, incorporando feedback de clientes e avanços tecnológicos para manter a competitividade da plataforma.
