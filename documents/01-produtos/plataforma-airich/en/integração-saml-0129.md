...
**Product:** AIRich Platform | **Department:** Products | **Date:** 2026-03-17 | **Versão:** 1.8

---

## Visão Geral

This operational manual describes the processes and responsibilities of Integração SAML.

A team de product da AIRich trabalha continuamente na evolução de Integração SAML, incorporando feedback de clients e avanços tecnológicos para manter a competitividade da plataforma.
