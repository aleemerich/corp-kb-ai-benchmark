...
**Product:** AIRich Platform | **Department:** Products | **Date:** 2026-06-23

---

## Visão Geral

This document aims to present Architecture de microsserviços for the teams involved.

A evolução constante do ecossystem AIRich demanda processs bem definidos. Architecture de microsserviços foi documentado para orientar as teams técnicas e operacionais na execução de suas atividades.
