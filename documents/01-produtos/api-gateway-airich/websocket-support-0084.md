...
**Produto:** AIRich API Gateway | **Departamento:** Produtos | **Data:** 2026-03-28 | **Versão:** 1.3

---

## Visão Geral

Este guia técnico aborda os aspectos fundamentais de WebSocket support na AIRich.

Alinhado com as melhores práticas do mercado, WebSocket support segue padrões estabelecidos pelas equipes de engenharia e operações da AIRich Tecnologia.
