...
**Produto:** AIRich API Gateway | **Departamento:** Produtos | **Data:** 2026-05-12

---

## Visão Geral

Este manual operacional descreve os processos e responsabilidades de SDK de integração.

Alinhado com as melhores práticas do mercado, SDK de integração segue padrões estabelecidos pelas equipes de engenharia e operações da AIRich Tecnologia.
