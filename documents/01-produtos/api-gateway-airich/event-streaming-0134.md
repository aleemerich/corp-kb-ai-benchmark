...
**Produto:** AIRich API Gateway | **Departamento:** Produtos | **Data:** 2026-08-22 | **Versão:** 1.3

---

## Visão Geral

O objetivo deste material é documentar as práticas recomendadas para Event streaming.

No cenário atual de transformação digital, Event streaming desempenha um papel fundamental na capacidade da AIRich de entregar valor aos seus clientes. Este documento estabelece as diretrizes para garantir consistência e eficiência.
