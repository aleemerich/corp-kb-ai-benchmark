...
**Produto:** AIRich Pay | **Departamento:** Produtos | **Data:** 2026-06-11 | **Versão:** 1.2

---

## Visão Geral

O presente documento tem como objetivo apresentar Strong Customer Authentication para as equipes envolvidas.

Como parte da estratégia de inovação da AIRich, Strong Customer Authentication foi projetado para suportar o crescimento escalável da plataforma, garantindo robustez e flexibilidade.
