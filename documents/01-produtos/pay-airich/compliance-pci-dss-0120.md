...
**Produto:** AIRich Pay | **Departamento:** Produtos | **Data:** 2026-03-08

---

## Visão Geral

Este documento fornece uma visão detalhada sobre Compliance PCI-DSS no ecossistema AIRich.

Alinhado com as melhores práticas do mercado, Compliance PCI-DSS segue padrões estabelecidos pelas equipes de engenharia e operações da AIRich Tecnologia.
