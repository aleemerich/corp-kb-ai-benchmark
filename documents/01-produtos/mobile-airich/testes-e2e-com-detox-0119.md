...
**Produto:** AIRich Mobile | **Departamento:** Produtos | **Data:** 2026-02-07

---

## Visão Geral

Este documento fornece uma visão detalhada sobre Testes E2E com Detox no ecossistema AIRich.

A evolução constante do ecossistema AIRich demanda processos bem definidos. Testes E2E com Detox foi documentado para orientar as equipes técnicas e operacionais na execução de suas atividades.
