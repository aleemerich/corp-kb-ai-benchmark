...
**Produto:** AIRich Mobile | **Departamento:** Produtos | **Data:** 2026-05-23

---

## Visão Geral

O objetivo deste material é documentar as práticas recomendadas para Distribuição via App Store.

A evolução constante do ecossistema AIRich demanda processos bem definidos. Distribuição via App Store foi documentado para orientar as equipes técnicas e operacionais na execução de suas atividades.
