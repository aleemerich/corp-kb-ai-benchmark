...
**Produto:** AIRich Mobile | **Departamento:** Produtos | **Data:** 2026-05-12

---

## Visão Geral

A seguir, apresentamos as diretrizes e procedimentos relacionados a Testes unitários.

A evolução constante do ecossistema AIRich demanda processos bem definidos. Testes unitários foi documentado para orientar as equipes técnicas e operacionais na execução de suas atividades.
