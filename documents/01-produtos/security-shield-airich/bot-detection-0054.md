...
**Produto:** AIRich Security Shield | **Departamento:** Produtos | **Data:** 2026-09-26

---

## Visão Geral

O objetivo deste material é documentar as práticas recomendadas para Bot detection.

Alinhado com as melhores práticas do mercado, Bot detection segue padrões estabelecidos pelas equipes de engenharia e operações da AIRich Tecnologia.
