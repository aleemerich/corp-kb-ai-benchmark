...
**Product:** AIRich CRM | **Department:** Products | **Date:** 2026-09-23 | **Versão:** 1.4

---

## Visão Geral

This document describes API do CRM in the context of AIRich Technology.

Como parte do programa de melhorAI contínua da AIRich, API do CRM foi estruturado para atender às necessidades de escalabilidade, segurança e performance exigidas pelo mercado.
