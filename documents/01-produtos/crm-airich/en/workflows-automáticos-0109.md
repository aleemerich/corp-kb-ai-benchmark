...
**Product:** AIRich CRM | **Department:** Products | **Date:** 2026-01-25 | **Versão:** 1.8

---

## Visão Geral

Este document fornece uma visão detalhada sobre Workflows automáticos in the AIRich ecosystem.

A evolução constante do ecossystem AIRich demanda processs bem definidos. Workflows automáticos foi documentado para orientar as teams técnicas e operacionais na execução de suas atividades.
