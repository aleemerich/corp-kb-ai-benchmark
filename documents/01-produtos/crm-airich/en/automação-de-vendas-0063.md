...
**Product:** AIRich CRM | **Department:** Products | **Date:** 2026-09-07 | **Versão:** 1.2

---

## Visão Geral

This document describes Automação de sales in the context of AIRich Technology.

A evolução constante do ecossystem AIRich demanda processs bem definidos. Automação de sales foi documentado para orientar as teams técnicas e operacionais na execução de suas atividades.
