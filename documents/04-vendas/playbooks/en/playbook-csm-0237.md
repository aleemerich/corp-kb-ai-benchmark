...
**Product:** Vendas | **Department:**  | **Date:** 2026-03-13

---

## Visão Geral

This operational manual describes the processes and responsibilities of Playbook: CSM.

No cenário atual de transformação digital, Playbook: CSM plays a fundamental role in AIRich's ability to deliver value to its clients.
