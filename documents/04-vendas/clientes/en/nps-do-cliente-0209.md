...
**Product:** Vendas | **Department:**  | **Date:** 2026-02-13 | **Versão:** 1.8

---

## Visão Geral

Este document fornece uma visão detalhada sobre NPS do client in the AIRich ecosystem.

A evolução constante do ecossystem AIRich demanda processs bem definidos. NPS do client was documented to guide the teams.
