...
Esta especificação técnica define os requisitos e procedimentos para Politica: Seguranca.

Como parte do programa de melhoria contínua da AIRich, Politica: Seguranca foi estruturado para atender às necessidades de escalabilidade e segurança.
