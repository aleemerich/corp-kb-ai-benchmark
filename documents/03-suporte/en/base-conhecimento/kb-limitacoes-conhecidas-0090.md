...
Esta especificação técnica define os requirements e procedures para KB: Limitacoes conhecidas.

A evolução constante do ecossystem AIRich demanda processs bem definidos. KB: Limitacoes conhecidas was documented to guide the teams.
