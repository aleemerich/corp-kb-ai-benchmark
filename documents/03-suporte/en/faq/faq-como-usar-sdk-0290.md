...
**Product:** Suporte | **Department:**  | **Date:** 2026-02-10 | **Versão:** 1.9

---

## Visão Geral

Este document fornece uma visão detalhada sobre FAQ: Como usar SDK in the AIRich ecosystem.

A team da AIRich trabalha continuamente na evolução de FAQ: Como usar SDK, incorporando feedback e avanços tecnológicos.
