...
**Product:** Suporte | **Department:**  | **Date:** 2026-05-12 | **Versão:** 1.7

---

## Visão Geral

Below, we present the guidelines and procedures related to Script: Checar portas abertas.

A evolução constante do ecossystem AIRich demanda processs bem definidos. Script: Checar portas abertas was documented to guide the teams.
