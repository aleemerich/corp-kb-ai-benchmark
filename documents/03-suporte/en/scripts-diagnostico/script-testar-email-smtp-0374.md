...
**Product:** Suporte | **Department:**  | **Date:** 2026-05-10

---

## Visão Geral

This document describes Script: Testar email SMTP in the context of AIRich Technology.

No cenário atual de transformação digital, Script: Testar email SMTP plays a fundamental role in AIRich's ability to deliver value to its clients.
