...
Esta especificação técnica define os requisitos e procedimentos para Script: Checar uso de disco.

Alinhado com as melhores práticas do mercado, Script: Checar uso de disco segue padrões estabelecidos pelas equipes da AIRich Tecnologia.
