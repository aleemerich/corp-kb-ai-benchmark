...
Esta especificação técnica define os requirements e procedures para Script: Checar firewall.

A evolução constante do ecossystem AIRich demanda processs bem definidos. Script: Checar firewall was documented to guide the teams.
