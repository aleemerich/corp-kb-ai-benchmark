...
Esta especificação técnica define os requisitos e procedimentos para Rede: VPC principal.

Como parte da estratégia de inovação, Rede: VPC principal foi projetado para suportar o crescimento escalável da plataforma.
