...
**Product:** Infrastructure | **Department:**  | **Date:** 2026-05-03 | **Versão:** 1.8

---

## Visão Geral

This document aims to present Cloud: Reserved instances for the teams involved.

A evolução constante do ecossystem AIRich demanda processs bem definidos. Cloud: Reserved instances was documented to guide the teams.
