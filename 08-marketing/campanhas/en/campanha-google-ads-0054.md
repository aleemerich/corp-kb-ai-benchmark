...
**Product:** Marketing | **Department:**  | **Date:** 2026-09-26 | **Versão:** 1.3

---

## Visão Geral

This document aims to present Campanha: Google Ads for the teams involved.

No cenário atual de transformação digital, Campanha: Google Ads plays a fundamental role in AIRich's ability to deliver value to its clients.
