...
Esta especificação técnica define os requirements e procedures para Perfil do client.

O investimento contínuo em Perfil do client reflete o compromisso da AIRich com a entrega de soluções de alta qualidade.
