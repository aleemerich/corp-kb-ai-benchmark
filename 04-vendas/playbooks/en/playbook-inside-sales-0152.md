...
**Product:** Vendas | **Department:**  | **Date:** 2026-08-12

---

## Visão Geral

Below, we present the guidelines and procedures related to Playbook: Inside sales.

No cenário atual de transformação digital, Playbook: Inside sales plays a fundamental role in AIRich's ability to deliver value to its clients.
